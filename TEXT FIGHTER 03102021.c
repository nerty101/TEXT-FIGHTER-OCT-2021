...
diceQ = (rand() % 2) + 1;
if (diceQ == 1)
printf("     You have accumulated a Bonus Chain total of %d!\n", bonchn5);
if (diceQ == 2)
printf("     You have a collected Bonus Chain total of %d!\n", bonchn5);
bonchn5 = 0;
bonrec5 = 1;
}
...
normag = 0;
magchn = 0;
dice5 = (rand() % 33 + (diflev + cpusp2));// 14 then was 17 THEN 18 then 19 NOW 20 OR 21??? 22 23 24 26 27 28 29 -1 28
...
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     That was a really great fight!\n");
if (diceQ == 2)
printf("     It was a completely spectacular fight!\n");
if (diceQ == 3)
printf("     That was a really excellent bout!\n");
if (diceQ == 4)
printf("     It was an absolutely amazing bout!\n");
