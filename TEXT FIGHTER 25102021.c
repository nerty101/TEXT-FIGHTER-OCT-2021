...
int spatt = 0, supspatt = 0, hypsp = 0, enspcomb1 = 0, enspcomb2 = 0, enspcomb3 = 0, enemspcombC = 0, c = 0, d = 0, e = 0, f = 0, g = 0, cpmag = 0, cpmag2 = 0, c2 = 0, diceS1 = 0, diceS2 = 0, diceS3 = 0;
...
int ans6 = 1, sumag5 = 0, spmag5 = 0, spmag6 = 0, magchn = 0, posmag2 = 0, cpusp3 = 0, spctrdf = 0, mspatt = 0, emgspcom = 0, mspatt2 = 0, emgspcom2 = 0, emgsupatt = 0, emagsup = 0, emagsup6 = 0, bonchn5 = 0;
...
int emgspcom5 = 0, emagsup5 = 0, mspatt5 = 0, enspcomb6 = 0, bonrec = 0, magrec = 0, bonrec2 = 0, magrec2 = 0, spmag3 = 0, fghton = 0, fghton2 = 0, new9 = 0, wnct8 = 0, cpuwn8 = 0, magsp4 = 0, f2 = 0, magchn5 = 0;
...
cpusp = 0;
cpusp2 = 0;
diceG = (rand() % 11) + 1;//new 06072021
if (diceG < 4)
++consecvic;
if (diceG < 2)
++consecvic;//new 06072021 finish
if (consecvic < 3)///
{
bonchn = 0;///
bonchn5 = 0;////new
...
if (bonchn == 1)
enemyhp = (enemyhp - 2 * dmg2);//1
if (bonchn == 2)
enemyhp = (enemyhp - 3 * dmg2);
if (bonchn == 3)
enemyhp = (enemyhp - 4 * dmg2);//1
if (bonchn >= 4)
...
++posmag;
++magchn;
if ((playerhp > 0) && (consecvic > 0))///new
{
magchn5 = magchn;///
magchn10 = magchn;
}
if (magchn > 2) ///changed from magchn > 1
{
diceL = (rand() % 12) + 1;//10
if (diceL < 5)  //5
consecvic = 1;
...
if (((ctr < 6) && ((bonchn > 2) || magchn > 2)))//new
{
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     It's an early finish to the contest!\n");
if (diceQ == 2)
printf("     You subdued the opponent quickly!\n");
if (diceQ == 3)
printf("     The contest finished early!\n");
if (diceQ == 4)
printf("     You gained a quick victory!\n");
}//new
if (cpulow > 0)
{
...
else if ((posmag > 0) && (magchn < 3) && (dubon > 0) && (consecvic > 2))///new added bonchn and above
{
...
printf("     The fight ended with a Magic Bonus Chain of %d!\n", magchn);
if (new3 > 0)
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
...
{
printf("     You have a new Special Round Chain Record!\n");
++new1;
}
...
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1))
{
printf("     And you have a new Special Round Chain Record!\n");
++new1;
}
...
if ((dice3 > dice4) && (magchn10 > 2) && (sumag10 < 1)) //&& (spmag2 == 0))/// && (spmag == 0))
{
...
if (magsp3 >= 1)///*************not equal one, more than, or equal one! bug otherwise!
{
spctrbon2 = spctrbon;
spctrbon = 0;
...
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1))
{
printf("     And it's a new Special Round Chain Record!\n");
++new1;
}
if ((new6 > 0) && (ctr > 5) && (cpusp > 1))
{
...
{
enemyhp = (enemyhp - 16 * dmg2); //was 11 12 14
...
{
diceE = (rand() % 26 + diflev + diceR) + 1;//maybe 28 24 26 33 24 26 22
}
else
{
if ((choice == 'n') && (choice != 'm') && (choice != 's'))
diceE = (rand() % 36 + diflev) + 1;//maybe 32 0r 34 32 33 30 32
}
if ((emagsup6 < 1) && (diceR < 1))//new ///****these blocks causing prob with combo announcements
///{//new
diceS1 = (rand() % 20) + 1;//6 10 12 18
///if (diceS1 == 1)
///{
///diceE = 0;
///}
///}//new
if ((emagsup6 > 0) || (diceS1 == 1))
{
diceE = 0;
}
if  ((diceE > 20) && (diceB >= 4) && (diceB <= 6) && (playerhp > 0) && (emagsup < 1) && (emagsup6 < 1) && (diceS1 != 1))
{
++d;
++d2;
playerhp = (playerhp - 4 * dmg2);
...
diceF = (rand() % 42 + diflev + diceR) + 1; //42 40 39 38
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 52 + diflev) + 1; ///54 52 51 50 48
}
...
if ((diceF > 29) && (diceR < 1))
diceS3 = (rand() % 20) + 1;//8 12 14
if ((playerhp < 1) || (emagsup > 0) || (emagsup6 > 0) || (diceS3 == 1))
{
diceC = 15;
}
else
...
diceC = (rand() % 82 + diflev) + 1; //72 73 74 75 78
else
if ((choice == 's') && (choice != 'm') && (choice != 'n'))
diceC = (rand() % 90 + diflev + diceR) + 1; //86 87 88 92 (not 86 higher) 90
}//added
//if ((diceF > 29) && (diceR < 1))
//{
//diceS3 = (rand() % 14) + 1;//8 12
//if (diceS3 == 1)
//{
//diceC = 0;
//}
//}
if  ((diceC > 47) && (diceB == 5) && (playerhp > 0) && (emagsup < 1)  && (emagsup6 < 1) && (diceS3 != 1))
{
++f;
++f2;
...
if ((enspcomb3 == 1) && (f > 0) && (e > 0) && (d > 0) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6)) && ((diceC > 47) && (diceB == 5)) && (emagsup < 1) && (emagsup5 < 1)  && (emagsup6 < 1) && (diceS3 != 1) && (diceS2 != 1) && (diceS1 != 1))
{
++ultdup;
if (ultdup == 1)
...
enspcomb2 = 0;
enspcomb1 = 0;
enemspcombC = 0;/// changed from enemspcombC = 1, at fault! unnecessary!
}
if (enemspcombC != 1)
{
if ((enspcomb1 == 1)  && (f < 1) && (e > 0) && (d > 0) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6)) && (emagsup < 1) && (emagsup5 < 1) && (emagsup6 < 1) && (diceS2 != 1) && (diceS1 != 1))
{
++supdup;
if (supdup == 1)
...
if ((enspcomb2 == 1) && (f > 0) && (e < 1) && (d > 0) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceC > 47) && (diceB == 5)) && (emagsup < 1) && (emagsup5 < 1) && (emagsup6 < 1) && (diceS3 != 1) && (diceS1 != 1))
{
++spdup;
if (spdup == 1)
...
if ((enspcomb2 == 1)  && (f > 0) && (e > 0) && (d < 1) && ((diceC > 47) && (diceB == 5)) && ((diceF > 29) && (diceB >= 5) && (diceB <= 6)) && (emagsup < 1) && (emagsup5 < 1) && (emagsup6 < 1) && (diceS3 != 1) && (diceS2 != 1))
{
++supdup2;
if (supdup2 == 1)
...
if ((cpusp > 1) && (cpusp > cpusp3) && (cpusp3 > 1))
{
printf("     A new Special Round Chain Record!\n");
++new1;
}
}
...
printf("\n");
if ((diceQ > 15) && (diceQ1 == 1) && (d2 < 1) && (e2 < 1) && (f2 < 1) && (g2 < 1))
printf("\n");
